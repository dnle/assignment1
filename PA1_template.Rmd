...
1. Load the data (read the csv file)
```{r, echo=TRUE}
...
hist(StepsTotal$steps, main = "Total steps by day", xlab = "Total number of steps", col = "yellow")
...
hist(total.steps.2$steps, xlab = "Total number of steps", col = "blue", main = "Histogram of total steps by day")
